...
public class Scoreboard extends JFrame implements ActionListener {
    ...
    JLabel teamADartsPoints, teamBDartsPoints, teamASetScore, teamBSetScore;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == numberPadEnter && resultNum <= 180 &&
                resultNum != 179 && resultNum != 178 && resultNum != 176 &&
                resultNum != 175 && resultNum != 173 && resultNum != 172 &&
                resultNum != 169 && resultNum != 166 && resultNum != 163 &&
                /* The values that resultNum can't be equal to represent invalid
                results that can occur in a game of darts */
                (amountOfPointsA >= resultNum || amountOfPointsB >= resultNum)) {
            playerTurn();
            teamAWinner();
            teamBWinner();
        }
